...
letter_input_1 = input('choose a letter... "v" for vowels, "c" for consonants, "l" for others..')
letter_input_2 = input('choose a letter... "v" for vowels, "c" for consonants, "l" for others..')
letter_input_3 = input('choose a letter... "v" for vowels, "c" for consonants, "l" for others..')
letter_input_4 = input('choose a letter... "v" for vowels, "c" for consonants, "l" for others..')
letter_input_5 = input('choose a letter... "v" for vowels, "c" for consonants, "l" for others..')
